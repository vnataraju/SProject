	...
	<div id="lofshowbiz-services-<?php echo $module->id; ?>" class="<?php echo $theme;?>">
		<ul>
    		...
    		<li>
    			...
    			<?php if( $showReadmore == 1 ):?><a class="buttondark <?php if( $showbiz == 1 ){echo "";}else{echo "morebutton";}?>" href="<?php if( $showbiz == 1 ){echo $item->link;}else{echo "#";}?>"><?php echo JText::_('Detail');?></a><?php endif;?>
...
<script type="text/javascript">
	...
	jQuery(document).ready(function() {
		...
		{										
			...
			transition:0,
            duration:<?php echo $durationCarousel;?>,
            durationSlide:<?php echo $durationSlide;?>,							
			touchenabled:"on",
