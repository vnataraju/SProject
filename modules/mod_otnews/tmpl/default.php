...
**/
/**------------------------------------------------------------------------
 * file: default.php 1.7.0 00001, April 2011 12:00:00Z OmegaTheme $
                    ...
                    <?php foreach ($list as $index=>$item) :  ?>
                        <?php if ($index === 0) { ?>
                            ...
                            <div class="first-item">
                                <!-- Show Titles -->
                                <div class="ot_head_title">
                                    <a href="<?php echo $item->link; ?>" class="head_title"><?php echo $item->title; ?></a>
                               </div>
                                <!-- Show thumbnails -->
                                <?php if($params->get('showthumbnails_head_item') == 1){?>
                                    <div class="otnews_thumbs"  style="width:<?php echo $params->get('thumbwidth')?>px; height:<?php echo $params->get('thumbheight')?>px;">
                                        <div class="otnews_thumbs_i"  style="width:<?php echo $params->get('thumbwidth')?>px; height:<?php echo $params->get('thumbheight')?>px;">
