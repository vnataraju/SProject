...
{
	var $_type = "";
	var $specialChars = array(0=>array("&"),
												  1=>array("&amp;"));
                ...
                echo '<div class="icemega_cover_module" style="width:'.$width.'px">';
                    for($i=0; $i<$cols; $i++)
                    {
                        ...
                        {  
							...
							{
								$module->title = str_replace( $this->specialChars[0],$this->specialChars[1], $module->title); 
                                ...
                                echo '<![CDATA['.$renderer->render($module,array("style"=>"")).']]>';
                                echo '</div>';
                            }
                        }
			        }
