...
<head>
	...
	<?php endif; ?>
		...
		<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/bootstrap/css/layout.css" type="text/css" media="screen,projection" />
		<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/bootstrap/css/print.css" type="text/css" media="Print" />
		<link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/bootstrap/css/bootstrap.css" type="text/css" />
        <link rel="stylesheet" href="<?php echo $this->baseurl ?>/templates/bootstrap/css/style.css" type="text/css" />
</head>
<body>
	<div align="center">
		<div id="outline">
