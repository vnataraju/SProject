	...
	public function ajaxAlbumSaveWall( $message , $uniqueId , $appId=null)
	{
	    ...
	    else
	    {
			...
			if( $my->id !== $album->creator )
			{
				...
				CNotificationLibrary::add( 'etype_photos_submit_wall' , $my->id , $album->creator , JText::sprintf('COM_COMMUNITY_PHOTO_WALL_EMAIL_SUBJECT' , $my->getDisplayName() ) , '' , 'album.wall' , $params );
			}
