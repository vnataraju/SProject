...
class CFieldsDate extends CProfileField
{
	...
	{		
		...
		$html .= '<input type="text" size="3" maxlength="2" name="field' . $field->id . '[]" value="' . $day . '" class="inputbox validate-custom-date '.  $class .'"'. $title.' /> ' . JText::_('COM_COMMUNITY_DAY_FORMAT');
		$html .= '&nbsp;/&nbsp;<select name="field' . $field->id . '[]" class="select validate-custom-date' . $class . '"'. $title.'>';
		...
		$html .= '</select>&nbsp;/&nbsp;';
		$html .= '<input type="text" size="5" maxlength="4" name="field' . $field->id . '[]" value="' . $year . '" class="inputbox validate-custom-date' . $class . '"'.$title.' /> ' . JText::_('COM_COMMUNITY_YEAR_FORMAT');
