...
class MyblogBloggerprefTask extends MyblogBaseController
{
	...
	function display()
	{
		...
		if( JRequest::getMethod() == 'POST' )
		{
			...
			$googlegears	= 0; //JRequest::getVar( 'googlegears' , 0 , 'POST' );
			...
			if( $user->store() )
			{
				$mainframe->enqueueMessage( JText::_('COM_MY_BLOG_ADMIN_PROFILE_UPDATED') );
			}
		}
...
// 		}
		...
		$showGoogleGears	= false; //$_MY_CONFIG->get('userUseGoGears' ) ? true : false;
