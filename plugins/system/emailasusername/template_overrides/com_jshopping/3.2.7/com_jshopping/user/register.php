...
include (JPATH_ROOT . DS . "components" . DS . "com_jshopping" . DS . 
	"templates" . DS . "default" . DS ."user/register.js.php");
?>
<div class="jshop">
    <?php if (!$hideheaderh1){?>
	...
	<input type = "hidden" name = "u_name" id = "u_name" value = "asd" class = "inputbox" />
