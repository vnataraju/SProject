...
<tbody>
	...
	<tr>
	    <td class="key">
			<label class="jomTips label" title="<?php echo JText::_( 'COM_COMMUNITY_DST_TIME_OFFSET' );?>::<?php echo JText::_('COM_COMMUNITY_DAYLIGHT_SAVING_OFFSET_TOOLTIP');?>" for="daylightsavingoffset">
