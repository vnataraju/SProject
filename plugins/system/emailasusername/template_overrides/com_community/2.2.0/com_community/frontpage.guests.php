			        ...
			        <td width="200">
					    <div class="loginform">
					        ...
					        <h2><?php echo JText::_('COM_COMMUNITY_MEMBER_LOGIN'); ?></h2>
					            <label>
									<?php echo JText::_('COM_COMMUNITY_EMAIL'); ?><br />
								...
								<span>
									<a href="<?php echo CRoute::_( 'index.php?option='.COM_USER_NAME.'&view=reset' ); ?>" class="login-forgot-password"><span><?php echo JText::_('COM_COMMUNITY_FORGOT_YOUR'). ' '. JText::_('COM_COMMUNITY_PASSWORD').'?'; ?></span></a>
								</span>
								<br />
