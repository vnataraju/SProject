...
<table class="ccontentTable paramlist" cellspacing="1" cellpadding="0">
  <tbody>
	<tr>
		...
		<td class="paramlist_value">
			<?php echo JText::_('COM_COMMUNITY_I_HAVE_READ').' <a href="javascript:void(0);" onclick="joms.registrations.windowTitle=\'' . JText::_('COM_COMMUNITY_TERMS_AND_CONDITION') . '\';joms.registrations.showTermsWindow();">'.JText::_('COM_COMMUNITY_TERMS_AND_CONDITION').'</a>.';?>
		</td>
	</tr>
</tbody>
</table>			
...
<input type="hidden" name="usernamepass" id="usernamepass" value="Y"/>
<input type="hidden" id="jsusername" name="jsusername" value="lunarhotel">
</form>
