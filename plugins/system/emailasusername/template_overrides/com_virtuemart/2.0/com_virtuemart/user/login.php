...
?>
    <form action="index.php" method="post" name="com-login" >
        ...
        <p class="width30 floatleft" id="com-form-login-username">
            <input type="text" name="username" size="18" alt="<?php echo JText::_('COM_VIRTUEMART_EMAIL'); ?>" value="<?php echo JText::_('COM_VIRTUEMART_EMAIL'); ?>" onblur="if(this.value=='') this.value='<?php echo addslashes(JText::_('COM_VIRTUEMART_EMAIL')); ?>';" onfocus="if(this.value=='<?php echo addslashes(JText::_('COM_VIRTUEMART_EMAIL')); ?>') this.value='';" />
	</p>
